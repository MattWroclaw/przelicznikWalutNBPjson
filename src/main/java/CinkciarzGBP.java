...
public class CinkciarzGBP {
    public static void roznicaCenyPound() throws IOException {
//        json z dzisiaj
        URL urlCenaTeraz = new URL(HttpNowAnd4WeeksAgo.gbpHttpNOW());
//        json sprzed 4 tygodni
        URL urlCenaMiesiacTemu = new URL(HttpNowAnd4WeeksAgo.gbpHttpMonthAgo());
        ...
        System.out.println("[GBP] Cena obecna - cena sprzed miesiąca = "+(ladnaCena.format(cenaTeraz-cenaMiesiacTemu))+" zł");
    }
