...
public class CinkciarzCHF {
    public static void roznicaCenyFrank() throws IOException {
//        json z dzisiaj
        URL urlCenaTeraz = new URL(HttpNowAnd4WeeksAgo.chfHttpNOW());
//        json sprzed 4 tygodni
        URL urlCenaMiesiacTemu = new URL(HttpNowAnd4WeeksAgo.chfHttpMonthAgo());
        ...
        System.out.println("[CHF] Cena obecna - cena sprzed miesiąca = "+(ladnaCena.format(cenaTeraz-cenaMiesiacTemu))+" zł");
    }
