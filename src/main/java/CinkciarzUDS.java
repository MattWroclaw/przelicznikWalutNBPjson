...
public class CinkciarzUDS {

    public static void roznicaCenyDolar() throws IOException {
//        json z dzisiaj
        URL urlCenaTeraz = new URL(HttpNowAnd4WeeksAgo.dolarHttpNOW());
//        json sprzed 4 tygodni
        URL urlCenaMiesiacTemu = new URL(HttpNowAnd4WeeksAgo.dolarHttpMonthAgo());
        ...
        System.out.println("[USD] Cena obecna - cena sprzed miesiąca = "+(ladnaCena.format(cenaTeraz-cenaMiesiacTemu))+" zł");
    }
