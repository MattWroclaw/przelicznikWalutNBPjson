...
public class Za100zlGBP {
    public static void ileGBPza100zl() throws IOException {
        double wartosc100zl= 0;

        URL urlEuro = new URL("http://api.nbp.pl/api/exchangerates/rates/c/gbp/today/?format=json");
