...
public class Za100zlUSD {
    public static void ileUSDza100zl() throws IOException {
        double wartosc100zl= 0;

        URL urlEuro = new URL("http://api.nbp.pl/api/exchangerates/rates/c/usd/today/?format=json");
        ...
        for (Rates dane : tabelaDanych) {
            ...
            System.out.println("Za 100zł kupisz :"+(ladnaCena.format(wartosc100zl))+" USD");
